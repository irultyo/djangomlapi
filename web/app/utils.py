...
def preprocess(index):
    ...
    image_path = base_dir / 'static' / 'images' / 'patches' / paths[index]
...
#    output_image = np.transpose(output_image, (1, 2, 0))
    ...
    output_image.save(base_dir / 'static' / 'images' / 'result' / result_name)
    return result_name
...
def api_generate_image(patch_a, patch_b, model_name):
    ...
    output_image = outputs[0][0]
    output_path = postprocess(output_image)
    output_path = base_dir / 'static' / 'images' / 'result' / output_path
